...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data() {
        return {
            ...
            ann_page_list: 'BBIN', //公告頁所屬部門 BBIN BBOS
    ...
    created: function () {
        ...
        //取得使用者群組資料
        var json = {};
        axios.post('/getAllBBINAccountData', json).then(function (response) {
    ...
    methods: {
        ...
        getAssets: function () {
            let self = this;
            axios.get('/bbinassets').then(function (response) {
        ...
        //     axios.post('/bbinreminderdataaboutann',json)
        ...
        createAsset: function () {
            ...
            axios.post('/bbinaccount-create/6', json) //新增 - 資產管理
            .then(function (response) {
        ...
        changeAssetUser: function (pm_id, ud_id) {
            ...
            json.pm_id = pm_id;
            json.ud_id = ud_id;
            axios.post('/bbinaccount-modify/6', json) //修改 - 資產管理
            .then(function (response) {
                if (response.data.result) {
                    self.getAssets();
                    self.closeAllDropdownMenu();
        ...
        deleteData: function () {
            ...
            axios.post('/bbinaccount-delete/' + self.ann_type, json) //刪除 - 公告
            .then(function (response) {
                self.getAssets();
                if (response.data.result) {
...
Component.options.__file = "C:\\xampp\\htdocs\\laravel\\projectManagement-2.0\\resources\\assets\\js\\pages\\BbinAccount.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] BbinAccount.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-586432a2", Component.options)
  } else {
    hotAPI.reload("data-v-586432a2", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("資產管理")])]), _vm._v(" "), _vm._l((_vm.user_group), function(group) {
    return _c('li', {
      staticClass: "select_item"
    }, [_c('a', {
      attrs: {
  ...
  }), _vm._v(" "), (_vm.search_show && _vm.sub_nav == 'asset') ? _c('input', {
    ...
    domProps: {
      "value": _vm.search_condition.asset_content
    },
    on: {
      "input": function($event) {
        return _vm.search()
  ...
  }) : _vm._e()]), _vm._v(" "), _vm._m(8), _vm._v(" "), (_vm.user_status.ud_admin) ? _c('a', {
    attrs: {
      "href": "/account-list"
    }
  ...
  }, [_vm._v("資產管理")]), _vm._v(" "), (_vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin) ? _c('div', {
  ...
  }, [_vm._v("adobe")]) : _vm._e(), _vm._v(" "), (_vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin) ? _c('div', {
    ...
    return _c('div', {
      ...
      class: {
        'none': !_vm.asset_field_show_or_not.ud_name == true, 'cursor': _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin, 'dropdown_item': _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin
      },
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin ? _vm.openDropdownMenu('ud_name', 'pm_id', asset.pm_id, $event) : false
        }
      }
    }, [_c('span', {
      directives: [{
      ...
      class: {
        'cursor': _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin
      }
      ...
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin ? _vm.showThisFieldInput('pm_host', asset.pm_id) : false
        }
      }
      ...
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin ? _vm.showThisFieldInput('pm_screenone', asset.pm_id) : false
        }
      }
      ...
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin ? _vm.showThisFieldInput('pm_screentwo', asset.pm_id) : false
        }
      }
      ...
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin ? _vm.showThisFieldInput('pm_telephone', asset.pm_id) : false
        }
      }
      ...
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin ? _vm.showThisFieldInput('pm_canvas', asset.pm_id) : false
        }
      }
      ...
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin ? _vm.showThisFieldInput('pm_other', asset.pm_id) : false
        }
      }
      ...
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin ? _vm.showThisFieldInput('pm_adobe', asset.pm_id) : false
        }
      }
    ...
    })]), _vm._v(" "), (_vm.user_status.ud_admin || _vm.user_auth.bbin_pm_admin) ? _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-586432a2", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("72e66218", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-586432a2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./BbinAccount.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-586432a2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./BbinAccount.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_BbinAccount__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_BbinAccount___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__pages_BbinAccount__);
// 匯入 BbinAccount.vue 檔，不需加副檔名
