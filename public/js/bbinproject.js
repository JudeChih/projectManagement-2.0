...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function () {
        ...
        if (array[1] == 'bbin-project-list') {
            self.project_ug_id = parseInt(array[2]);
            self.project_udc_id = 1;
        }
        //取得使用者群組資料
        var json = {};
        json.ug_id = self.project_ug_id;

        axios.post('/getAllBBINProjectData', json).then(function (response) {
            ...
            if (!self.user_status.ud_admin && !self.user_auth.bbin_pt_admin && self.sub_projects.length == 0) {
                var string = '';
                // self.sub_projects = [];
                for (var i = 0; i < response.data.sub_projects.length; i++) {
                    if (string != response.data.sub_projects[i].pt_id) {
                        ...
                        var json = {};
                        json.pt_id = string;
                        axios.post('/bbingetsubprojectsofproject', json).then(function (response) {
            ...
            } else if (self.user_status.ud_admin || self.user_auth.bbin_pt_admin) {
                ...
                if (self.project_status == '全部任務') {
                    ...
                    for (var i = 0; i < array_c.length; i++) {
                        ...
                        if (array_d.length > 0) {
                            ...
                            if (self.user_status.ud_admin || self.user_auth.bbin_pt_admin) {
                                array_c[i].sub_projects = array_d;
                                array_e.push(array_c[i]);
                            }
                        }
    ...
    methods: {
        ...
        getUserData: function () {
            ...
            axios.get('/sessionStatus').then(function (response) {
                if (response.data) {
                    ...
                    self.getUserTags();
                    //取得該使用者加最愛的專案
                    axios.post('/bbinuserfavorites', response.data).then(function (response) {
        ...
        getProjects: function () {
            let self = this;
            axios.get('/bbinprojects/' + self.project_ug_id).then(function (response) {
        ...
        getSubProjects: function () {
            let self = this;
            axios.get('/bbinsubprojects').then(function (response) {
                if (!self.user_status.ud_admin && !self.user_auth.bbin_pt_admin && self.sub_projects.length == 0) {
                    var string = '';
                    // self.sub_projects = [];
        ...
        getReminderDataAboutAnn: function () {
            ...
            var json = {};
            json.ud_id = self.user_status.ud_id;
            axios.post('/bbinreminderdataaboutann', json).then(function (response) {
        ...
        getUserInThisTag: function () {
            ...
            axios.post('/bbinuserinthistag', json).then(function (response) {
        ...
        drop: function (id) {
            ...
            axios.post('/bbinproject-modify/1', self.drag_data) //修改 專案任務的標籤
        ...
        createProject: function () {
            ...
            axios.post('/bbinproject-create/1', json) //新增 - 專案主任務
            .then(function (response) {
                if (response.data.result) {
                    self.openSinglePage(self.user_status, 'bbin-pt', response.data.id, 1);
                } else {
                    self.notification(response.data.string, 'failure');
                }
            }).catch(function (response) {
        ...
        createTag: function () {
            ...
            if (tm_name == '') {
                ...
                json.ug_id = self.project_ug_id;
                json.ud_id = self.user_status.ud_id;
                axios.post('/bbinproject-create/5', json) //新增 - 標籤
                .then(function (response) {
                    if (response.data.result) {
                        self.notification(response.data.string, 'success');
                        self.closeTagWrap();
        ...
        addUserToThisTag: function (ud_id) {
            ...
            json.ud_id = ud_id;
            json.tm_id = self.tag_data.tm_id;
            axios.post('/bbinuser-to-tag-create', json).then(function (response) {
                if (response.data.result) {
                    self.notification(response.data.string, 'success');
                    self.getUserInThisTag();
        ...
        changeTagStyle: function () {
            ...
            if (tm_name == '') {
                ...
                json.tm_url = tm_url;
                json.ug_id = self.project_ug_id;
                axios.post('/bbinproject-modify/5', json) //修改 - 標籤
                .then(function (response) {
                    if (response.data.result) {
                        self.notification(response.data.string, 'success');
                        self.closeTagWrap();
        ...
        changeExecuteItem: function (pst_id, peic_id) {
            ...
            axios.post('/bbinproject-modify/2', arraydata) //修改 - 專案子任務
            .then(function (response) {
                if (response.data.result) {
                    self.getSubProjects();
                    self.closeAllDropdownMenu();
        ...
        changeRequireDate: function (obj) {
            ...
            if (obj.pt_id) {
                ...
                axios.post('/bbinproject-modify/1', arraydata) //修改 - 專案主任務
                .then(function (response) {
                    if (response.data.result) {
                        self.getProjects();
                    } else {
        ...
        changeProjectItem: function (type) {
            ...
            if (self.sub_nav == 'wait' || self.sub_nav == 'all') {
                ...
                if (type != self.sub_nav) {
                    ...
                    axios.post('/bbinproject-show-modify', self.drag_data) //修改 專案任務的顯示與否
                    .then(function (response) {
                        if (response.data.result) {
                            self.getProjects();
                            self.notification(response.data.string, 'success');
                ...
                axios.post('/bbinproject-tag-delete', self.drag_data) //修改 專案任務的標籤欄位
                .then(function (response) {
                    if (response.data.result) {
                        self.getProjects();
                        self.notification(response.data.string, 'success');
        ...
        deleteUserFromThisTag: function (trm_id) {
            ...
            var json = {};
            json.trm_id = trm_id;
            axios.post('/bbinuser-from-tag-delete', json).then(function (response) {
                if (response.data.result) {
                    self.notification(response.data.string, 'success');
                    self.getUserInThisTag();
                } else {
...
Component.options.__file = "C:\\xampp\\htdocs\\laravel\\projectManagement-2.0\\resources\\assets\\js\\pages\\BbinProject.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] BbinProject.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6828519b", Component.options)
  } else {
    hotAPI.reload("data-v-6828519b", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('li', {
      class: {
        'select_item': true, 'current': _vm.project_ug_id == group.ug_id && _vm.project_udc_id == 1
      }
    }, [_c('a', {
      attrs: {
    ...
    staticClass: "nav_item nav_hover",
    class: {
      'current': _vm.project_udc_id == 1 || _vm.ann_page_list == 'BBIN'
    }
  }, [_c('a', {
    staticClass: "nav_a",
    attrs: {
  ...
  }, [_vm._m(15)]), _vm._v(" "), ((_vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin) && _vm.sub_nav == 'wait') ? _c('li', {
    class: {
  ...
  }, [_vm._m(16)]) : ((_vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin) && _vm.sub_nav != 'wait') ? _c('li', {
    class: {
      'current': _vm.sub_nav == 'wait'
    },
    attrs: {
    ...
    return (tag.ug_id == _vm.project_ug_id) ? _c('li', {
      directives: [{
        name: "rightMenu",
        rawName: "v-rightMenu",
        value: (_vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.menudata : false),
        expression: "user_status.ud_admin || user_auth.bbin_pt_admin ?menudata : false"
      }],
      class: {
  ...
  }), _vm._v(" "), (_vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin) ? _c('li', {
    staticClass: "add_tag",
    on: {
      "click": function($event) {
  ...
  }, [_vm._v("進行中")])]) : _vm._e()]) : _vm._e(), _vm._v(" "), ((_vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin) && _vm.sub_nav != 'finish') ? _c('div', {
    ...
    return _c('div', {
    ...
    }, [(_vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin) ? _c('div', {
      ...
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.deleteFavorite(pro.pt_id) : false
        }
      }
    }) : _c('i', {
      ...
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.createFavorite(pro.pt_id) : false
        }
      }
    })]), _vm._v(" "), _c('div', {
      ...
      on: {
        "click": function($event) {
          return _vm.openSinglePage(_vm.user_status, 'bbin-pt', pro.pt_id, 1)
        }
      }
      ...
      class: {
        'none': !_vm.list_field_show_or_not.all.pst_requiredate == true, 'cursor': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin, 'dropdown_item': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin
      },
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.openDropdownMenu('pt_requiredate', 'pt_id', pro.pt_id, $event) : false
        }
      }
      ...
      return _c('div', {
        ...
        on: {
          "dragstart": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.dragToChangeProjectSort("start", pro.pt_id, sub.pst_id) : false
          },
          "dragend": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.dragToChangeProjectSort("end", pro.pt_id, sub.pst_id) : false
          },
          "drop": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.dragToChangeProjectSort("drop", pro.pt_id, sub.pst_id) : false
          },
          "dragover": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.allowDrop($event) : false
          },
        ...
        class: {
          'cursor': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin || _vm.user_status.ud_id == sub.ud_id
        },
        on: {
          "click": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin || _vm.user_status.ud_id == sub.ud_id ? _vm.openSinglePage(_vm.user_status, 'bbin-pst', sub.pst_id, 1) : false
          }
        }
        ...
        class: {
          'none': !_vm.list_field_show_or_not.all.peic_name == true, 'cursor': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin
        },
        on: {
          "click": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.openDropdownMenu('peic_name', 'pst_id', sub.pst_id, $event) : false
          }
        }
        ...
        on: {
          "click": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.openDropdownMenu('pst_requiredate', 'pst_id', sub.pst_id, $event) : false
          }
        }
        ...
        staticClass: "content_text cell pst_executiondate",
        class: {
          'none': !_vm.list_field_show_or_not.all.pst_executiondate == true, 'cursor': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin, 'dropdown_item': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin
        },
        on: {
          "click": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.openDropdownMenu('pst_executiondate', 'pst_id', sub.pst_id, $event) : false
          }
        }
        ...
        staticClass: "content_text cell pst_completiondate",
        class: {
          'none': !_vm.list_field_show_or_not.all.pst_completiondate == true, 'cursor': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin, 'dropdown_item': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin
        },
        on: {
          "click": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.openDropdownMenu('pst_completiondate', 'pst_id', sub.pst_id, $event) : false
          }
        }
        ...
        staticClass: "content_text cell ud_name",
        class: {
          'none': !_vm.list_field_show_or_not.all.ud_name == true, 'cursor': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin, 'dropdown_item': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin
        },
        on: {
          "click": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.openDropdownMenu('ud_name', 'pst_id', sub.pst_id, $event) : false
          }
        }
      }, [(sub.ud_name) ? _c('span', {
        staticClass: "dropdown_item"
        ...
        staticClass: "content_text cell psc_name",
        class: {
          'none': !_vm.list_field_show_or_not.all.psc_name == true, 'cursor': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin, 'dropdown_item': _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin
        },
        on: {
          "click": function($event) {
            _vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin ? _vm.openDropdownMenu('psc_name', 'pst_id', sub.pst_id, $event) : false
          }
        }
      }, [(sub.psc_name) ? _c('p', {
        staticClass: "dropdown_item",
    ...
    }), _vm._v(" "), ((_vm.user_status.ud_admin || _vm.user_auth.bbin_pt_admin)) ? _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6828519b", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("34c72568", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-6828519b\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./BbinProject.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-6828519b\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./BbinProject.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_BbinProject__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_BbinProject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__pages_BbinProject__);
// 匯入 BbinProject.vue 檔，不需加副檔名
