...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function () {
        ...
        //取得使用者群組資料
        var json = {};
        axios.post('/getAllAnnouncementData', json).then(function (response) {
            ...
            self.data_anns = response.data.data_anns;
    ...
    computed: {
        new_data: function () {
            ...
            var array_c = [];
            var array_d = [];
            for (var i = 0; i < self.data_anns.length; i++) {
                if (self.data_anns[i].ai_topping == 1) {
                    array_a.push(self.data_anns[i]);
                } else {
                    array_b.push(self.data_anns[i]);
                }
            }
            ...
            if (self.search_condition.ann_content != '') {
                ...
                for (var k = 0; k < array_d.length; k++) {
                    var boolean = true;
                    for (var l = 0; l < self.reminder_data.length; l++) {
                        if (array_d[k].ai_id == self.reminder_data[l].ai_id) {
                            array_d[k].url_reminderdate = self.reminder_data[l].url_reminderdate;
                            boolean = false;
                        }
                    }
                    if (boolean) {
                ...
                for (var k = 0; k < array_c.length; k++) {
                    var boolean = true;
                    for (var l = 0; l < self.reminder_data.length; l++) {
                        if (array_c[k].ai_id == self.reminder_data[l].ai_id) {
                            array_c[k].url_reminderdate = self.reminder_data[l].url_reminderdate;
                            boolean = false;
                        }
                    }
                    if (boolean) {
    ...
    methods: {
        ...
        changeAssetUser: function (pm_id, ud_id) {
            ...
            json.pm_id = pm_id;
            json.ud_id = ud_id;
            axios.post('/announcement-modify/6', json) //修改 - 資產管理
            .then(function (response) {
                if (response.data.result) {
                    self.getAssets();
                    self.closeAllDropdownMenu();
...
Component.options.__file = "C:\\xampp\\htdocs\\laravel\\projectManagement-2.0\\resources\\assets\\js\\pages\\Announcement.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5c161b30", Component.options)
  } else {
    hotAPI.reload("data-v-5c161b30", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    class: {
      'current': _vm.sub_nav == 0
    },
    on: {
      "click": function($event) {
        _vm.sub_nav = 0, _vm.getAnns(0), _vm.closeAll()
      },
  ...
  }, [(_vm.sub_nav == 0 || _vm.tabHover == 0) ? _c('img', {
    attrs: {
    ...
    return _c('li', {
      class: {
        'current': _vm.sub_nav == group.ug_id
      },
      on: {
        "click": function($event) {
          _vm.sub_nav = group.ug_id, _vm.getAnns(group.ug_id), _vm.closeAll()
        },
        "mouseover": function($event) {
          _vm.tabHover = group.ug_id
        },
        "mouseleave": function($event) {
          _vm.tabHover = -1
        }
      ...
      staticClass: "tag_item"
    }, [(_vm.sub_nav == group.ug_id || _vm.tabHover == group.ug_id) ? _c('img', {
      attrs: {
        "src": "/image/coffee-solid_hover.png"
      }
    }) : _c('img', {
    ...
    }), _vm._v(" "), _c('p', [_vm._v(_vm._s(group.ug_name) + "公告")])])])
  })], 2)]), _vm._v(" "), _c('div', {
    ...
    on: {
      "click": function($event) {
        _vm.create_ann_open ? _vm.create_ann_open = false : _vm.create_ann_open = true
      }
    }
  }, [_vm._v("新增公告")]) : _vm._e()]), _vm._v(" "), (_vm.create_ann_open) ? _c('div', {
    ...
    staticClass: "found_nothing_wrap"
  }, [_vm._v("暫無公告")]) : _vm._e()])])]), _vm._v(" "), (_vm.checkToOpenSingle()) ? _c('singlepage', {
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5c161b30", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("4ce145be", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-5c161b30\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Announcement.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-5c161b30\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Announcement.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_Announcement__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_Announcement___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__pages_Announcement__);
// 匯入 Announcement.vue 檔，不需加副檔名
