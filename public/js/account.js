...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Singlepage_vue__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Reminderwrap_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Reminderwrap_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_Reminderwrap_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        ...
        reminderwrap: __WEBPACK_IMPORTED_MODULE_1__components_Reminderwrap_vue___default.a
    },
    data() {
        return {
            users: [], //全部使用者資料
            auths: [], //全部權限等級資料
            user_status: [], //登入的使用者資料
            user_group: [], //使用者所屬群組
            //基本設定值
            delete_id: '', //要刪除的資料的編號
            auth_type: '', //1.權限等級
            sub_nav: 'account_management',
            prompt_box_open: false,
    ...
    created: function () {
        ...
        //取得使用者群組資料
        var json = {};
        json.auth_order = self.auth_order;
        json.auth_sort = self.auth_sort;
        json.user_order = self.user_order;
        json.user_sort = self.user_sort;
        axios.post('/getAllAccountData', json).then(function (response) {
    ...
    methods: {
        ...
        search: function () {
            ...
            setTimeout(function () {
                if (self.composing) {
                    if (self.sub_nav == 'account_management') {
                        self.search_condition.user_content = $('input[name=search_content]').val();
                    } else if (self.sub_nav == 'authority_level') {
        ...
        getAuths: function () {
            let self = this;
            var json = {};
            json.order = self.auth_order;
            json.sort = self.auth_sort;
        ...
        getUsers: function () {
            let self = this;
            var json = {};
            json.order = self.user_order;
            json.sort = self.user_sort;
        ...
        changeUserSort: function (order) {
            let self = this;
            if (self.user_order == order) {
                if (self.user_sort == 'DESC') {
                    self.user_sort = 'ASC';
                    self.getUsers();
                } else {
                    self.user_sort = 'DESC';
        ...
        changeAuthSort: function (order) {
            let self = this;
            if (self.auth_order == order) {
                if (self.auth_sort == 'DESC') {
                    self.auth_sort = 'ASC';
                    self.getAuths();
                } else {
                    self.auth_sort = 'DESC';
        ...
        deleteAuth: function () {
            ...
            if (self.auth_type !== '') {
                ...
                axios.post('/auth-delete/' + self.auth_type, json) //刪除 - 權限等級
                .then(function (response) {
                    self.getAuths();
                    self.closePrompt();
                    if (response.data.result) {
        ...
        //開啟刪除詢問視窗
        openDeleteAuthPromptBox: function (id, type) {
            //1.權限等級
            let self = this;
            var string = '';
            self.auth_type = type;
...
Component.options.__file = "C:\\xampp\\htdocs\\laravel\\projectManagement-2.0\\resources\\assets\\js\\pages\\Account.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7ab188d4", Component.options)
  } else {
    hotAPI.reload("data-v-7ab188d4", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  })], 2)]), _vm._v(" "), _vm._m(3), _vm._v(" "), _vm._m(4), _vm._v(" "), _vm._m(5)]) : _vm._e()]), _vm._v(" "), _c('div', {
  ...
  }), _vm._v(" "), (_vm.search_show && _vm.sub_nav == 'account_management') ? _c('input', {
  ...
  }) : (_vm.search_show && _vm.sub_nav == 'authority_level') ? _c('input', {
    staticClass: "search_input",
    class: {
  ...
  }) : _vm._e()]), _vm._v(" "), _vm._m(6), _vm._v(" "), _vm._m(7), _vm._v(" "), _c('li', {
    on: {
      "click": function($event) {
  ...
  }, [(_vm.sub_nav == 'account_management') ? _c('li', {
    class: {
      'current': _vm.sub_nav == 'account_management'
    },
    on: {
      "click": function($event) {
        _vm.sub_nav = 'account_management'
      }
    }
  }, [_vm._m(8)]) : _c('li', {
    class: {
  ...
  }, [_vm._m(9)]), _vm._v(" "), (_vm.sub_nav == 'authority_level') ? _c('li', {
    class: {
      'current': _vm.sub_nav == 'authority_level'
    },
    on: {
      "click": function($event) {
        _vm.sub_nav = 'authority_level'
      }
    }
  }, [_vm._m(10)]) : _c('li', {
    class: {
  ...
  }, [_vm._m(11)])])]), _vm._v(" "), (_vm.sub_nav == 'account_management') ? _c('div', {
    staticClass: "right"
  }, [_c('div', {
  ...
  }, [_vm._v("\n                            員工代號\n                            "), (_vm.user_order == 'ud_code' && _vm.user_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.user_order == 'ud_code' && _vm.user_sort == 'ASC') ? _c('i', {
  ...
  }, [_vm._v("\n                            帳號\n                            "), (_vm.user_order == 'ud_account' && _vm.user_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.user_order == 'ud_account' && _vm.user_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("\n                            暱稱\n                            "), (_vm.user_order == 'ud_name' && _vm.user_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.user_order == 'ud_name' && _vm.user_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "head_text cell udc_name cursor",
    on: {
      "click": function($event) {
        return _vm.changeUserSort('udc_name')
      }
    }
  }, [_vm._v("\n                            部門\n                            "), (_vm.user_order == 'udc_name' && _vm.user_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.user_order == 'udc_name' && _vm.user_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("\n                            組別\n                            "), (_vm.user_order == 'ug_name' && _vm.user_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.user_order == 'ug_name' && _vm.user_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
    ...
    return _c('div', {
      ...
      staticClass: "content_text cell udc_name"
    }, [_vm._v(_vm._s(user.udc_name))]), _vm._v(" "), _c('div', {
    ...
    staticClass: "found_nothing_wrap"
  }, [_vm._v("暫無使用者")]) : _vm._e()])]) : _vm._e(), _vm._v(" "), (_vm.sub_nav == 'authority_level') ? _c('div', {
    staticClass: "right"
  }, [_c('div', {
    staticClass: "right_wrap"
  }, [_c('div', {
  ...
  }, [_vm._v("\n                            層級名稱"), (_vm.auth_order == 'al_name' && _vm.auth_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.auth_order == 'al_name' && _vm.auth_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "head_text cell pt_admin cursor",
    on: {
      "click": function($event) {
        return _vm.changeAuthSort('bbin_pt_admin')
      }
    }
  }, [_vm._v("\n                            BBIN專案"), (_vm.auth_order == 'bbin_pt_admin' && _vm.auth_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.auth_order == 'bbin_pt_admin' && _vm.auth_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "head_text cell pt_admin cursor",
    on: {
      "click": function($event) {
        return _vm.changeAuthSort('bbos_pt_admin')
      }
    }
  }, [_vm._v("\n                            BBOS專案"), (_vm.auth_order == 'bbos_pt_admin' && _vm.auth_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.auth_order == 'bbos_pt_admin' && _vm.auth_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("\n                            公告"), (_vm.auth_order == 'ai_admin' && _vm.auth_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.auth_order == 'ai_admin' && _vm.auth_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "head_text cell pm_admin cursor",
    on: {
      "click": function($event) {
        return _vm.changeAuthSort('bbin_pm_admin')
      }
    }
  }, [_vm._v("\n                            BBIN資產"), (_vm.auth_order == 'bbin_pm_admin' && _vm.auth_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.auth_order == 'bbin_pm_admin' && _vm.auth_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "head_text cell pm_admin cursor",
    on: {
      "click": function($event) {
        return _vm.changeAuthSort('bbos_pm_admin')
      }
    }
  }, [_vm._v("\n                            BBOS資產"), (_vm.auth_order == 'bbos_pm_admin' && _vm.auth_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.auth_order == 'bbos_pm_admin' && _vm.auth_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("\n                            書籍"), (_vm.auth_order == 'bi_admin' && _vm.auth_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.auth_order == 'bi_admin' && _vm.auth_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("\n                            備註"), (_vm.auth_order == 'al_remark' && _vm.auth_sort == 'DESC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down"
  }) : (_vm.auth_order == 'al_remark' && _vm.auth_sort == 'ASC') ? _c('i', {
    staticClass: "fas fa-sort-amount-down-alt"
  }) : _vm._e()]), _vm._v(" "), _c('div', {
    ...
    return _c('div', {
    ...
    }, [_vm._v(_vm._s(auth.al_name))])]), _vm._v(" "), (auth.bbin_pt_admin) ? _c('div', {
      staticClass: "content_text cell pt_admin"
    }, [_vm._v("可編輯")]) : _c('div', {
      staticClass: "content_text cell pt_admin"
    }, [_vm._v("僅查看")]), _vm._v(" "), (auth.bbos_pt_admin) ? _c('div', {
      staticClass: "content_text cell pt_admin"
    }, [_vm._v("可編輯")]) : _c('div', {
      staticClass: "content_text cell pt_admin"
      ...
      staticClass: "content_text cell ai_admin"
    }, [_vm._v("僅查看")]), _vm._v(" "), (auth.bbin_pm_admin) ? _c('div', {
      staticClass: "content_text cell pm_admin"
    }, [_vm._v("可編輯")]) : _c('div', {
      staticClass: "content_text cell pm_admin"
    }, [_vm._v("僅查看")]), _vm._v(" "), (auth.bbos_pm_admin) ? _c('div', {
      staticClass: "content_text cell pm_admin"
    }, [_vm._v("可編輯")]) : _c('div', {
      staticClass: "content_text cell pm_admin"
    ...
    }, [_vm._v(_vm._s(auth.al_remark))])]), _vm._v(" "), _c('div', {
      staticClass: "content_text cell btn_delete"
    }, [_c('i', {
      staticClass: "far fa-trash-alt",
      on: {
        "click": function($event) {
          return _vm.openDeleteAuthPromptBox(auth.al_id, 1)
        }
      }
    })])])])
    ...
    staticClass: "found_nothing_wrap"
  }, [_vm._v("暫無權限等級")]) : _vm._e()])]) : _vm._e()]), _vm._v(" "), (_vm.checkToOpenSingle()) ? _c('singlepage', {
    attrs: {
    ...
    on: {
      "click": function($event) {
        return _vm.deleteAuth()
      }
    }
  }, [_vm._v("確認")]) : _c('div', {
    staticClass: "btn_submit"
  }, [_vm._v("確認")]), _vm._v(" "), _vm._m(13)])])]), _vm._v(" "), _c('reminderwrap', {
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7ab188d4", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("4cff6637", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-7ab188d4\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Account.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-7ab188d4\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Account.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_Account__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_Account___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__pages_Account__);
// 匯入 Account.vue 檔，不需加副檔名
