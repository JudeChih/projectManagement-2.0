...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function () {
        ...
        axios.post('/getAllBookData', json).then(function (response) {
            ...
            self.data_books = response.data.data_books;
            self.book_infor = response.data.data_books[0];
            self.data_bookborrows = response.data.data_bookborrows;
            self.data_booksorts = response.data.data_booksorts;
            self.cate_bookstatus = response.data.cate_bookstatus;
    ...
    computed: {
        ...
        books: function () {
            ...
            var array_a = [];
            var array_b = [];
            for (var i = 0; i < self.data_books.length; i++) {
                if (self.book_infor.bs_id == self.data_books[i].bs_id) {
                    array_a.push(self.data_books[i]);
                }
            }
            return array_a;
        }
    ...
    methods: {
        ...
        getBooks: function () {
            ...
            axios.get('/books').then(function (response) {
                if (response.data.length > 0) {
                    self.data_books = response.data;
                    self.book_infor = self.data_books[0];
                    self.getBorrowing(self.data_books[0].bi_id);
                } else {
                    self.book_infor = {};
                }
            }).catch(function (response) {
        ...
        getBorrowing: function (id) {
            ...
            axios.get('/borrowing/' + id).then(function (response) {
                self.data_bookborrows = response.data;
            }).catch(function (response) {
                self.notification('系統出錯', 'failure');
            });
        },
        ...
        getBookSort: function () {
            ...
            axios.get('/booksort').then(function (response) {
                self.data_booksorts = response.data;
            }).catch(function (response) {
                self.notification('系統出錯', 'failure');
            });
        },
        ...
        getBookStatusCate: function () {
            ...
            axios.get('/bookstatuscate').then(function (response) {
                self.cate_bookstatus = response.data;
            }).catch(function (response) {
                self.notification('系統出錯', 'failure');
            });
        },
        ...
        changeBookSort: function (id, name) {
            let self = this;
            self.book_infor = {};
            self.book_infor.bs_id = id;
            self.book_infor.bs_name = name;
            self.data_bookborrows = [];
        },
        ///
        ////////////////////////其他有用功能 end////////////////////////
        ...
        createBorrowing: function () {
            let self = this;
            var json = {};
            json.bi_id = self.book_infor.bi_id;
            if (self.create_book_data.ud_id) {
                json.ud_id = self.create_book_data.ud_id;
            } else {
                self.notification('請選擇借閱人', 'failure');
                return false;
            }
            if (self.create_book_data.bbr_borrowingdate) {
                json.bbr_borrowingdate = self.create_book_data.bbr_borrowingdate;
            } else {
                self.notification('請選擇借閱日期', 'failure');
                return false;
            }
            if (self.create_book_data.bbr_returndate) {
                json.bbr_returndate = self.create_book_data.bbr_returndate;
            }
            axios.post('/book-create/3', json) //新增 - 書籍借閱
            .then(function (response) {
                if (response.data.result) {
                    self.closeAll();
                    self.getBorrowing(self.book_infor.bi_id);
                } else {
        ...
        createBorrowingDate: function (obj) {
            let self = this;
            self.create_book_data.bbr_borrowingdate = obj.date;
        },
        //設定歸還時間
        createReturnDate: function (obj) {
            let self = this;
            self.create_book_data.bbr_returndate = obj.date;
        },
        ///
        //////////////////// 新增區塊 end ////////////////////
        ...
        deleteData: function () {
            ...
            axios.post('/book-delete/' + self.ann_type, json) //刪除 - 公告
            .then(function (response) {
                self.getBorrowing(self.book_infor.bi_id);
                if (response.data.result) {
...
Component.options.__file = "C:\\xampp\\htdocs\\laravel\\projectManagement-2.0\\resources\\assets\\js\\pages\\Book.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1ea0c8d2", Component.options)
  } else {
    hotAPI.reload("data-v-1ea0c8d2", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" "), (_vm.search_show) ? _c('input', {
    ...
    on: {
      "click": function($event) {
        _vm.book_infor ? _vm.openDropdownMenu('bs_name', 'bs_id', _vm.book_infor.bs_id, $event) : false
      }
    }
  }, [(_vm.book_infor && _vm.book_infor.bs_name) ? _c('span', {
    staticClass: "dropdown_item"
  }, [_vm._v(_vm._s(_vm.book_infor.bs_name))]) : _c('span', {
    staticClass: "dropdown_item"
  }, [_vm._v("請先新增書籍")]), _vm._v(" "), (_vm.book_infor && _vm.checkToOpenDropDown('bs_name', 'bs_id', _vm.book_infor.bs_id)) ? _c('i', {
    staticClass: "fas fa-chevron-up dropdown_item"
  }) : _c('i', {
    staticClass: "fas fa-chevron-down dropdown_item"
  }), _vm._v(" "), (_vm.book_infor && _vm.checkToOpenDropDown('bs_name', 'bs_id', _vm.book_infor.bs_id)) ? _c('div', {
    staticClass: "drop_down_wrap dd_wrap"
  }, [_c('ul', {
    staticClass: "infor_ul dd_wrap"
  }, [(_vm.data_booksorts.length < 1) ? _c('li', {
    staticClass: "infor_li dd_wrap"
  }, [_vm._v("請先新增書籍")]) : _vm._e(), _vm._v(" "), _vm._l((_vm.data_booksorts), function(sort) {
    return _c('li', {
      staticClass: "infor_li dd_wrap",
      class: {
        'current': _vm.book_infor.bs_id == sort.bs_id
      },
      on: {
        "click": function($event) {
    ...
    on: {
      "click": function($event) {
        _vm.book_infor ? _vm.openDropdownMenu('bi_name', 'bi_id', _vm.book_infor.bi_id, $event) : false
      }
    }
  }, [(_vm.book_infor && _vm.book_infor.bi_name) ? _c('span', {
    staticClass: "dropdown_item"
  }, [_vm._v(_vm._s(_vm.book_infor.bi_name))]) : (_vm.books.length < 1) ? _c('span', {
    staticClass: "dropdown_item"
  }, [_vm._v("請先新增書籍")]) : _c('span', {
    staticClass: "dropdown_item"
  }, [_vm._v("請選擇")]), _vm._v(" "), (_vm.book_infor && _vm.checkToOpenDropDown('bi_name', 'bi_id', _vm.book_infor.bi_id)) ? _c('i', {
    staticClass: "fas fa-chevron-up dropdown_item"
  }) : _c('i', {
    staticClass: "fas fa-chevron-down dropdown_item"
  }), _vm._v(" "), (_vm.book_infor && _vm.checkToOpenDropDown('bi_name', 'bi_id', _vm.book_infor.bi_id)) ? _c('div', {
    staticClass: "drop_down_wrap dd_wrap"
  }, [_c('ul', {
    staticClass: "infor_ul dd_wrap"
    ...
    return _c('li', {
      staticClass: "infor_li dd_wrap",
      class: {
        'current': _vm.book_infor && _vm.book_infor.bi_id == infor.bi_id
      },
      on: {
        "click": function($event) {
  ...
  }, [_vm._v("新增書籍")]) : _vm._e(), _vm._v(" "), (_vm.book_infor && (_vm.user_status.ud_admin || _vm.user_auth.bi_admin) && _vm.book_infor.bi_id) ? _c('div', {
    staticClass: "btn_modify dd_wrap",
    on: {
      "click": function($event) {
        return _vm.openSinglePage(_vm.user_status, 'bi', _vm.book_infor.bi_id, 6)
      }
    }
  ...
  }, [(_vm.book_infor && _vm.book_infor.bi_fileurl) ? _c('img', {
    attrs: {
      "src": _vm.book_infor.bi_fileurl,
      "alt": "書籍圖片"
    }
  }) : _c('img', {
    attrs: {
  ...
  })]), _vm._v(" "), (_vm.book_infor && _vm.book_infor.bi_name) ? _c('p', {
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.book_infor.bi_name))]) : _vm._e(), _vm._v(" "), (_vm.book_infor && _vm.book_infor.bi_purchasedate) ? _c('p', {
    staticClass: "date"
  }, [_vm._v("進貨日期： " + _vm._s(_vm.book_infor.bi_purchasedate))]) : _vm._e(), _vm._v(" "), (_vm.book_infor && _vm.book_infor.ud_name) ? _c('p', {
    staticClass: "user"
  }, [_vm._v("資產： " + _vm._s(_vm.book_infor.ud_name))]) : _vm._e(), _vm._v(" "), (_vm.book_infor && _vm.book_infor.bsc_name) ? _c('p', {
    staticClass: "status"
  }, [_vm._v("狀態： " + _vm._s(_vm.book_infor.bsc_name))]) : _vm._e(), _vm._v(" "), (_vm.book_infor && _vm.book_infor.bi_message) ? _c('textarea', {
    attrs: {
      "name": "",
      "id": "",
      "cols": "30",
    ...
    domProps: {
      "value": _vm.book_infor.bi_message
    }
  }) : _vm._e()])]), _vm._v(" "), _c('div', {
  ...
  }, [(_vm.book_infor && (_vm.user_status.ud_admin || _vm.user_auth.bi_admin) && _vm.book_infor.bi_id) ? _c('div', {
    staticClass: "btn_create dd_wrap",
    on: {
      "click": function($event) {
        _vm.create_book_open ? _vm.closeAll() : _vm.create_book_open = true
      }
    }
  ...
  }, [(_vm.create_book_data.ud_name) ? _c('span', {
    staticClass: "dropdown_item"
  }, [_vm._v(_vm._s(_vm.create_book_data.ud_name))]) : _c('span', {
    staticClass: "dropdown_item"
    ...
    return _c('li', {
      staticClass: "infor_li dd_wrap",
      class: {
        'current': _vm.create_book_data.ud_id == user.ud_id
      },
      on: {
        "click": function($event) {
          _vm.create_book_data.ud_name = user.ud_name, _vm.create_book_data.ud_id = user.ud_id, _vm.closeAllDropdownMenu()
        }
      }
    }, [(user.ud_icon) ? _c('img', {
      staticClass: "dd_wrap",
  ...
  }, [(_vm.create_book_data.bbr_borrowingdate) ? _c('span', {
    staticClass: "dropdown_item"
  }, [_vm._v(_vm._s(_vm.create_book_data.bbr_borrowingdate))]) : _c('span', {
    staticClass: "dropdown_item"
  }, [_vm._v("-")]), _vm._v(" "), (_vm.checkToOpenDropDown('bbr_borrowingdate', 'bbr_id', 'create')) ? _c('datetimepicker', {
    attrs: {
      "id": _vm.create_book_data.bbr_id,
      "type": "bbr_id",
      "date": _vm.create_book_data.bbr_borrowingdate,
  ...
  }, [(_vm.create_book_data.bbr_returndate) ? _c('span', {
    staticClass: "dropdown_item"
  }, [_vm._v(_vm._s(_vm.create_book_data.bbr_returndate))]) : _c('span', {
    staticClass: "dropdown_item"
  }, [_vm._v("-")]), _vm._v(" "), (_vm.checkToOpenDropDown('bbr_returndate', 'bbr_id', 'create')) ? _c('datetimepicker', {
    attrs: {
      "id": _vm.create_book_data.bbr_id,
      "type": "bbr_id",
      "date": _vm.create_book_data.bbr_returndate,
      "position": _vm.dropdown.position
    },
    on: {
      "get-close": _vm.closeDateTimePicker,
  ...
  })])]) : _vm._e(), _vm._v(" "), _vm._l((_vm.new_data), function(book) {
    return _c('div', {
      staticClass: "bottom_item row"
    }, [_c('div', {
      staticClass: "content_text cell"
    }, [(book.ud_name) ? _c('span', {
      directives: [{
        name: "highlight",
        rawName: "v-highlight",
        value: ({
    ...
    }, [_vm._v(_vm._s(book.ud_name))]) : _c('span', [_vm._v("-")])]), _vm._v(" "), _c('div', {
      staticClass: "content_text cell"
    }, [(book.bbr_borrowingdate) ? _c('span', [_vm._v(_vm._s(book.bbr_borrowingdate))]) : _c('span', [_vm._v("-")])]), _vm._v(" "), _c('div', {
      staticClass: "content_text cell",
      class: {
        'cursor': _vm.user_status.ud_admin || _vm.user_auth.bi_admin, 'dropdown_item': _vm.user_status.ud_admin || _vm.user_auth.bi_admin
      },
      on: {
        "click": function($event) {
          _vm.user_status.ud_admin || _vm.user_auth.bi_admin ? _vm.openDropdownMenu('bbr_returndate', 'bbr_id', book.bbr_id, $event) : false
        }
      }
    }, [(book.bbr_returndate) ? _c('span', {
      staticClass: "dropdown_item"
    }, [_vm._v(_vm._s(book.bbr_returndate))]) : _c('span', {
      staticClass: "dropdown_item"
    }, [_vm._v("-")]), _vm._v(" "), (_vm.checkToOpenDropDown('bbr_returndate', 'bbr_id', book.bbr_id)) ? _c('datetimepicker', {
      attrs: {
        "id": book.bbr_id,
        "type": "bbr_id",
        "date": book.bbr_returndate,
        "position": _vm.dropdown.position
      },
      on: {
        "get-close": _vm.closeDateTimePicker,
      ...
      on: {
        "click": function($event) {
          return _vm.openDeletePromptBox(book.bbr_id, 3)
        }
      }
    })]) : _vm._e()])
  ...
  })]) : _vm._e()])])]), _vm._v(" "), (_vm.checkToOpenSingle()) ? _c('singlepage', {
    attrs: {
    ...
    staticClass: "btn_submit"
  }, [_vm._v("確認")]), _vm._v(" "), _vm._m(15)])])]), _vm._v(" "), (_vm.loading) ? _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-1ea0c8d2", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("3ca4ad38", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-1ea0c8d2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Book.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-1ea0c8d2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Book.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_Book__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_Book___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__pages_Book__);
// 匯入 Book.vue 檔，不需加副檔名
